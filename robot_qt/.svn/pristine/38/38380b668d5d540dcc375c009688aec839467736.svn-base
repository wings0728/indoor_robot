...
private slots:
  ...
  void expressGuideSlot(t3_description::GuideState state);
  void chargeSlot(t3_description::GuideState state);
  void normalGuideSlot(t3_description::GuideState state);
  void interviewSlot();
  void showUISlot();
